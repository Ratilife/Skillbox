...
КонецПроцедуры
Функция ВыгрузитьВJSON(Значение) Экспорт
	...
	Возврат JSON(Значение,СтруктураТипов)
	
КонецФункции // ()


Функция JSON(Значение,СтруктураТипов) Экспорт
	Возврат НеФорматированныйJSON(Значение,СтруктураТипов);	
КонецФункции

Функция ЗагрузитьИзJSON(СтрJSON) Экспорт
	Перем Значение;
		Если НЕ ЗначениеЗаполнено(ЭтотОбъект.ХранилищеСтруктурыТипов) Тогда
		ЗаполнитьСтруктуруТипов();
	КонецЕсли; 
 ...
 Возврат UnJSON(СтрJSON,СтруктураТипов) ;
